<div class="attraction-card-second-right" style="margin-bottom:5em;">
    ...
    <div class="gdlr-core-pbf-column gdlr-core-column-30 gdlr-core-column-first" id="gdlr-core-column-4">
        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js"
            style="padding-top: 90px; padding-right: 55px; padding-bottom: 37px;">
                ...
                <div class="gdlr-core-pbf-element">
                    <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align"
                        ...
                        <div class="gdlr-core-text-box-item-content"
                            style="font-size: 18px; font-weight: 400; text-transform: none; color: #898989;">
                            <p>
                                {{ $slot }}
                            </p>
                        </div>
    ...
    <div class="gdlr-core-pbf-column gdlr-core-column-30" id="gdlr-core-column-5">
        <div class="gdlr-core-pbf-column-content-margin gdlr-core-js" style="margin: 80px 0px 0px 0px;">
                ...
                <div class="gdlr-core-pbf-element">
                    <div class="gdlr-core-image-item gdlr-core-item-pdb gdlr-core-center-align gdlr-core-item-pdlr"
                        ...
                        <div class="gdlr-core-image-item-wrap gdlr-core-media-image gdlr-core-image-item-style-round"
                            ...
                            <img src="{{ $img }}" alt="" width="1300" height="716"
                                title="bar" style="max-height:500px;object-fit:cover"/>
                        </div>
                    </div>
                </div>
            </div>
