<x-layouts.master>
    ...
    <x-breadcrumbs title="Dwuosobowy Pokój Deluxe z Balkonem" bgi="{{ asset('assets/images/owce-dwie_40.webp') }}" />

    <x-apartment.template title="Dwuosobowy Pokój Deluxe z Balkonem" price="od 299 zł">
        ...
        <x-slot name="features">
            <x-apartment.featureCard title="Liczba Gości" desc="max 2 os.">
